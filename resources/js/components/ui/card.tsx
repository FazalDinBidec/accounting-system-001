...
function Card({
    ...
    return (
        <div data-slot="card"
            className={
                cn("bg-card text-card-foreground flex flex-col rounded border py-6 shadow-sm", className)
            }
            {...props}/>
    )
}
...
function CardHeader({
    ...
    return (
        <div data-slot="card-header"
            className={
                cn("flex flex-col gap-1.5 px-4", className)
            }
            {...props}/>
    )
}
...
function CardFooter({
    ...
    return (
        <div data-slot="card-footer"
            className={
                cn("flex items-center px-6", className)
            }
            {...props}/>
    )
}
