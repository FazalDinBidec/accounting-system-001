...
import { dateInputValue, formatMoney, toMoneyNumber } from '@/pages/purchases/types';
...
export default function PurchaseForm({
    ...
    function updateItem(index: number, field: keyof FormItem, value: string): void {
        setData(
            'items',
        ...
        <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded p-4">
            <Card className="overflow-hidden py-0">
                <CardHeader className="border-b py-6">
                    <Heading title={isEditing ? 'Edit Purchase' : 'Create New Purchase'} />
                </CardHeader>
                                ...
                                <Table className="table-fixed">
                                    <TableHeader>
                                        <TableRow>
                                            ...
                                            <TableHead className="w-[18%]">Batch No</TableHead>
                                        ...
                                        {data.items.map((item, index) => (
                                            <TableRow key={index}>
                                                ...
                                                <TableCell>
                                                    ...
                                                    />
                                                    <InputError message={errors[`items.${index}.batch_no`]} />
                                                </TableCell>
                                                <TableCell>
                                                    <Input
                                                        type="number"
                                                ...
                                                <TableCell className="text-center font-medium">
                                                    {formatMoney(
                                                        toMoneyNumber(item.quantity) * toMoneyNumber(item.unit_price),
                                                    )}
                                                </TableCell>
