...
import type { Account, AccountParentOption, AccountType } from '@/pages/accounts/types';
        ...
        <>
            ...
            <div className="grid gap-2">
                ...
                <FormSelect
                    ...
                    options={accountTypes.map(([value, label]) => ({ value, label }))}
                />
            ...
            <div className="grid gap-2">
                ...
                <FormSelect
                    id="parent_id"
                    name="parent_id"
                    defaultValue={account?.parent_id ? String(account.parent_id) : ''}
                    emptyLabel="None"
